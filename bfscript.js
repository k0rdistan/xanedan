(function() {
    ...
    menuCards.forEach(card => {
        card.addEventListener('click', (e) => {
            ...
            const btn = card.querySelector('.order-btn:not(.disabled)');
            if (btn && !btn.disabled) {
                btn.click();
            }
        });
    ...
    // -------------------- QUICK VIEW BUTTONS --------------------
    const quickViewBtns = document.querySelectorAll('.quick-view:not(.disabled)');
    ...
    function updateActiveNav() {
        ...
        navLinks.forEach(link => {
            ...
            if (link.getAttribute('href') === 'index.html#home' && currentPage === 'breakfasts.html') {
                // Keep no active state on breakfast page
            }
        });
    }
    updateActiveNav();

    console.log('XANEDAN - Breakfast Page Loaded Successfully! 🍳');
})();